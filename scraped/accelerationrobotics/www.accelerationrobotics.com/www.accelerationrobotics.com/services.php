...
<head>
    ...
    <title>Hardware acceleration services for robots</title>
    <link rel="stylesheet" href="css/servicios.css">
    <link rel="stylesheet" href="css/assessments.css">
    <link rel="stylesheet" href="css/home.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Wruczek/Bootstrap-Cookie-Alert@gh-pages/cookiealert.css">
    <meta name="description" content="Our robot hardware acceleration services help hardware accelerate sensing, perception, mapping, localization, motion control, low-level control and actuation." />
    <meta name="keywords" content="acceleration services robotics,hardware acceleration robotics,fpga consulting robots,gpu consulting robots" />
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h4 class="linkotherservices mt-4"><a href="products.php"><i class="fa fa-chevron-left"></i> Products</a></h4>
                    <h1 class="f-blanco pt-1">Hardware Acceleration <br>Services</h1>
                    <p class="f-blanco pt-5" style="font-size:1.2em">
                        Hardware acceleration will revolutionize robotics, enabling new applications by speeding up robot response times while remaining power-efficient. Our services help rapidly augment your engineering capabilities with a robotics deep domain expertise.
                    </p>
                </div>
            </div>
            <div class="row justify-content-md-center py-4">
                <div class="col-md-4 text-center">
                    <img src="img/pantallas-services-consulting.png" alt="" class="img-responsive" style="max-height:320px;">
                    <h4 class="f-blanco f-gordita-bold py-3" style="font-size:1.3em">ROBOTICS<br>CONSULTING</h4>
                    <a href="robotics-consulting.php" class="btn-flecha btn-readmore mb-3">
                        <span class="circle"><span class="icon arrow"></span></span><span class="button-text">Learn more</span>
                    </a>
                </div>
                <div class="col-md-4 text-center">
                    <img src="img/pantalla-services-design.png" alt="" class="img-responsive" style="max-height:320px;">
                    <h4 class="f-blanco f-gordita-bold py-3" style="font-size:1.3em">ROBOT FPGA AND GPU<br>IP DESIGN SERVICES</h4>
                    <a href="robot-ip-design.php" class="btn-flecha btn-readmore mb-3">
                        <span class="circle"><span class="icon arrow"></span></span><span class="button-text">Learn more</span>
                    </a>
                </div>
            </div>
