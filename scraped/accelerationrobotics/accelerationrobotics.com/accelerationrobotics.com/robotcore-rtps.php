 ...
 <head>
    ...
    <!--<script src="js/fontawesome.js" crossorigin="anonymous"></script>-->
     ...
     <title>ROBOTCORE® RTPS | An FPGA implementation of DDS-RTPS communication middleware</title>
     <meta name="description" content="An FPGA implementation of DDS-RTPS communication middleware" />
     <meta name="keywords" content="fpga,ros,rtps,dds,robotics" />
    ...
    <div class="alert text-center cookiealert" role="alert">
         ...
         <div class="container">
             <div class="row no-gutters">
                 <div class="col-12 col-lg-6 my-auto">
                     ...
                     <h1 class="titulo-robotcore">ROBOTCORE <span>RTPS</span></h1>
                     <h3 class="f-blanco f-gordita-normal py-2" style="font-size:1.8em;">                         
                         <!-- Accelerating Robotic RTPS Networking to Microsecond Speeds -->
                         <!-- DDS-RTPS Real-Time Robotics Networking in Microseconds -->
                         An FPGA implementation of DDS-RTPS for Real-Time Robotics Networking
                     </h3>
                     <p class="mt-1 pb-4" style="color: white;">
                        <strong class="f-blanco">ROBOTCORE® RTPS</strong> is an expertly crafted FPGA <strong
                             style="color:#4d4cf5;">robot core</strong> (also known as IP core) that implements in hardware the Real-Time Publish Subscribe (RTPS) protocol, the communication backbone of the Data Distribution Service (DDS), and by extension, ROS 2. ROBOTCORE® RTPS interoperates with popular DDS implementations and its hardware design is central to facilitating fast, real-time, efficient networking data distribution within DDS and ROS 2's sophisticated ecosystem, providing a robust foundation for advanced robotic communications. With the capability to send or receive <strong
                             style="color:#4d4cf5;">small DDS payloads in about 1.5 microseconds</strong> in off-the-shelf FPGAs, it achieves a remarkable <u>26x speedup</u> on average over traditional CPU software implementations of RTPS and DDS.                          
                     </p>
                     <a href="start-buying.php" class="btn btn-linea btn-relleno smooth mb-2">Get ROBOTCORE® RTPS</a>
                 ...
                 <div class="col-12 col-lg-6 my-auto text-center text-lg-right pt-5 pt-lg-0">
                     <img src="img/RTPS_N_500.gif" alt="ROBOTCORE RTPS" class="img-responsive iconorobotcore">
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="mt-5 mb-0 our-duty-home" id="our-duty-home">
         <div class="container containerAC">
             <div class="row no-gutters">
                 <div class="col-12">
                     <h2 class="pb-0">Accelerate your robot networking.<br>Lightspeed RTPS and DDS communications</h2>
                     <!-- <h2>Revolutionizing robot connectivity:Lightning-Speed Robot Networking Communications<h2> -->
                     <!-- <h2>How does it work?</h2> -->
                     <img src="img/robotcore_rtps.svg" style="margin-top: -10px;"
                         class="img-responsive d-none d-lg-block mb-1 pt-0"> <!-- img-robots-full -->
                     <img src="img/robotcore_rtps_vertical.svg"
                         class="img-responsive mx-auto d-block d-lg-none mb-1 pt-3">

                     <p class="mb-3 text-justify" style="margin-top: -50px;">
                        ROBOTCORE® <strong style="color:#4d4cf5;">RTPS</strong> implements the RTPS protocol and parts of the <strong style="color:#4d4cf5;">DDS</strong> communication middleware. RTPS and DDS are vital for the networking communications in robotics and industrial automation. DDS, or Data Distribution Service, acts like a communication 'databus', a system that connects and transfers data between robotic components over the network (unlike a database that stores data). RTPS, standing for Real-Time Publish Subscribe, is a protocol that defines the DDS communication middleware Interoperability Wire Protocol (OMG's DDSI-RTPS™). Integral to <strong style="color:#4d4cf5;">ROS 2</strong>, RTPS makes data sharing in robotics more efficient. ROBOTCORE® RTPS provides a hardware implementation of RTPS and DDS that excels in sending or receiving data fast, taking about <u>3 microseconds for small packets</u> round-trip, making it <strong style="color:#4d4cf5;">26 times faster than traditional CPU</strong> implementations. It's designed to work seamlessly with popular DDS implementations, enhancing its ability to distribute data quickly and reliably in complex robotic systems.
                     </p>
                     <img src="img/robotcore_rtps_diagram.svg" style="margin-top: -10px;"
                         class="img-responsive d-block pb-4 mb-4 pt-4">

                     <a href="#benchmarks" class="mt-4 mb-5 btn btn-relleno">Benchmarks <i class="fas fa-chevron-right"
                             aria-hidden="true"></i>
                     </a>
                 </div>
             </div>
         ...
         <div class="container containerAC">
             <div class="row">
                 <div class="col-12 col-lg-4 div-img mt-5">
                     ...
                     <h4 class="f-gordita-normal pr-lg-5">ROBOTCORE® RTPS supports the most popular FPGA silicon
             ...
             <div class="row">
                 <div class="col-12 col-lg-4 div-img mt-5">
                     ...
                     <h4 class="f-gordita-normal pr-lg-5">
                         ROBOTCORE® <strong style="color:#4d4cf5;">RTPS</strong> is particularly advantageous in
         ...
         <div class="container">
             <div class="row py-5">
                 <div class="col-12 text-center">
                     <h2>
                         Faster ROS networking communications<br> with ROBOTCORE® RTPS
                     </h2>
                     <p>
                         ROBOTCORE® <span style="color:#4d4cf5;"><strong>RTPS</strong></span> significantly enhances
                         the networking architecture of robotic systems, especially those utilizing ROS 2, by
                         offering accelerated RTPS and DDS networking capabilities. It can be used alone for ultra-fast DDS interactions or combined with other robot cores to interoperate with popular robotic operating systems.  Its integration into these popular robot middlewares enables single-digit microsecond-level communication speeds, drastically improving
                         real-time data processing and responsiveness when combined with ROBOTCORE® <span style="color:#4d4cf5;"><strong>UDP/IP</strong></span> and ROBOTCORE® <span style="color:#4d4cf5;"><strong>ROS 2</strong></span>. All while delivering the common ROS development
                         flow when combined with ROBOTCORE® <span style="color:#4d4cf5;"><strong>Framework</strong></span>.
                     </p>
                     <p class="pt-4 pb-0 text-center">
                         <img src="img/architecture_framework_udpip_ros2.png" class="img-responsive">
                     </p>

                     <a href="robotcore-udpip.php" class="mb-4 mt-0 btn btn-relleno">ROBOTCORE UDP/IP <i
                             class="fas fa-chevron-right" aria-hidden="true"></i>
                     </a>
                     <a href="robotcore-ros2.php" class="mb-4 btn btn-linea">ROBOTCORE ROS 2 <i class="fas fa-chevron-right" aria-hidden="true"></i>
                     </a>
                 </div>
             </div>
         </div>
             ...
             <div class="row pb-5">
                <div class="col-12 col-lg-7 d-lg-block pb-5 justify-content-center align-self-center">                 
                 ...
                 <div class="col-12 offset-lg-1 col-lg-4 div-img mt-5">
                     ...
                     <h4 class="f-gordita-normal pr-lg-5">                     
                        ROBOTCORE® <strong style="color:#4d4cf5;">RTPS</strong> outperforms other IP core solution combinations delivering DDS and RTPS capabilities, including both deployments in hard- and soft-cores<sup style="font-size: small; color: #999;"><a href="#ref5">[5]</a></sup>. 
                     </h4>
                    <!-- Footnotes Section -->
                    <ol class="footnotes" style="font-size: x-small; color: #999; counter-reset: list-item 4;">
                        <li class="reference-item" id="ref5"> eProsima. <span style="text-decoration: underline;" href="https://www.youtube.com/watch?v=n9V8wN5cBRM"> Safe DDS - Kria KR260 ROS 2 Demo</span>. Assuming RTT values.</li>                        
                    </ol>
                    <style>
     ...
     <div class="especify-about" id="benchmarks">
         <div class="container containerAC">
             ...
             <p style="font-size:0.8rem">(<span style="color:#4d4bfb;">see <a href="robotcore-ros2.php">ROBOTCORE® ROS 2</a> for more</span>)</p>
             ...
             <!-- <div class="row" style="border-bottom: 0 !important; padding: 3em 0 2em 0;"> -->
                 ...
                 <div class="col-lg-6 col-xl-4">
                     <p> <strong>Latency for small DDS payloads</strong> (us)<br> (<i style="font-size:0.8rem">one-way maximum
                             latency measured after 10K samples and while sending small DDS payloads with ROBOTCORE
                             RTPS and ROBOTCORE UDP/IP running in an FPGA@156MHz. Other fmax values may lead to better results.</i>) </p>
                 </div>
                 <div class="col-lg-6 col-xl-4">
                     <p><strong style="color:#4d4bfb;">1.5 us</strong></p>
                     </p>
                 </div>
             </div>
             ...
             <!-- <div class="row" style="border-bottom: 0 !important; padding: 3em 0 2em 0;"> -->
                 ...
                 <div class="col-lg-6 col-xl-4">
                     <p> <strong>RTT latency for small DDS payloads</strong> (us)<br> (<i style="font-size:0.8rem">round-trip maximum
                             latency measured after 10K samples and while sending small DDS payloads with ROBOTCORE
                             RTPS and ROBOTCORE UDP/IP running in an FPGA@156MHz. Other fmax values may lead to better results.</i>) </p>
                 </div>
                 <div class="col-lg-6 col-xl-4">
                     <p><strong style="color:#4d4bfb;">3 us</strong></p>
                     </p>
                 </div>
             </div>
             ...
             <div class="row" style="border-bottom: 0 !important; padding: 3em 0 2em 0;">
                 ...
                 <div class="col-lg-6 col-xl-4">
                     <p><strong style="color:#4d4bfb;">26x</strong></p>
                 </div>
             </div>
    ...
    gtag('config', 'G-G3FEGN3FKT');
     ...
     <script>
         ...
         const data_corechart = {
             labels: labels,
             datasets: [{
                     label: 'ROBOTCORE RTPS (FPGA@156MHz)',
                     data: [5.9, 0],
        ...
        const data_horizontal = {
            ...
            labels: [
                "ROBOTCORE ROS 2 + RTPS + UDP/IP (FPGA@156MHz)",
                "ROS 2 + DDS1 (CPU)",
                "ROS 2 + DDS2 (CPU)",
                "ROS 2 + DDS3 (CPU)",
                "ROS 2 + eCAL (CPU)",
            ...
            [
                ...
                // - https://gitlab.com/accelerationrobotics/products/robotcore-rtps/-/issues/4
                {
                    ...
                    data: [5, 1061, 339, 328, 376],
                    backgroundColor: '#d9d9da',
                },
                {
                    label: "Max. latency (us)",
                    data: [0, 336750, 22769, 109776, 5532],
            ...
            options: {
                ...
                scales: {
                    x: {
                        ...
                        title: {
                            display: true,
                            text: "Small Packet Round-Trip Network Latency (us), measured with ROS 2",
                            padding: {
                                top: 30,
                                left: 0,
                                right: 0,
        ...
        const data_cores = {
            // ROBOTCORE, Connext, FastDDS, CycloneDDS, eCAL
            labels: [
                "ROBOTCORE RTPS + UDP/IP (FPGA@156MHz)",
        ...
        let radarplot_udpip = radarplot([11.35, 5.96, 7.35, 23.15], 'radarplot_udpip', "ROBOTCORE RTPS");
        let radarplot_udpip_intel = radarplot([11.35, 5.96, 7.35, 23.15], 'radarplot_udpip_intel', "ROBOTCORE RTPS");
     </script>
 </body>
